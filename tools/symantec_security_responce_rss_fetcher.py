...
# symantec の RSS を読み込んでtweet します。
...
rss_url = "http://www.symantec.com/ja/jp/xml/rss/listings.jsp?lid=latestthreats30days"
...
def GetRSSText(url):
    ...
    for item in entries:
        ...
        #if "summary_detail" in item.keys():
        #text += item.summary_detail['value'].encode('utf8') + "\n"
